...
#CSVファイルへの書き込み
hand_df1.to_csv("Answer_sheet/AI_11_saved_files/hand_df1_1.csv", encoding='shift-jis')

#CSVファイルの読み込み
hand_df2 = pd.read_csv("Answer_sheet/AI_11_saved_files/hand_df1_1.csv", encoding='shift-jis')
