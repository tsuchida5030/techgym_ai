...
def draw_2d_2groups(vectors, target1, target2, topn=100):
    # print(f'デバッグ　model.wv.most_similar(老人, topn=100)：{vectors.wv.most_similar(target1, topn=topn)}')
    ...
    # print(f'デバッグ　similars：{similars}')
    # print(f'デバッグ　type(similars)：{type(similars)}')
...
draw_2d_2groups(model, words[0], words[1])